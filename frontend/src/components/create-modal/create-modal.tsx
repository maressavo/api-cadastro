        ...
        <div className="modal-overlay">
            <div className="modal-body">
                ...
                <form action="" className="input" onSubmit={enviar}>
                    ...
                    <div><Input label="Telefone" value={telefone} updateValue={setTelefone} required/></div>
                    <div><Input label="Data de Nascimento" value={dataNasc} updateValue={setDataNasc} required/></div>
                    <div>
